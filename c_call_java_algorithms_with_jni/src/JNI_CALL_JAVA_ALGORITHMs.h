...
class JNI_CALL_JAVA_ALGORITHMs {
	...
	const static string JAVA_CLASS_PATH;
	const static string JAVA_JAR_FILE_PATH;
	const static string ALG_K_SHORTESTPATH_CLASSPATH;
	const static string ALG_SHORTESTPATH_CLASSPATH;
public:
...
//	    descriptor: (Ljava/lang/String;)V
	void JNI_CALL_JAVA_Constructor_KShortestPath_Instance(const string fileName);
	...
	void JNI_CALL_JAVA_Get_KShortestPaths(const string source, const string destination);
	...
	void JNI_CALL_JAVA_Get_KShortestPathsWith_KLimit(const string source, const string destination, const int k);
	...
	//	    descriptor: (Ljava/lang/String;Ljava/lang/String;I)Ljava/util/ArrayList;
	void JNI_CALL_JAVA_Get_KShortestPathsWith_HopMinimumLimit(const string source, const string destination, const int minimumHop);
	...
	//	    descriptor: (Ljava/lang/String;Ljava/lang/String;I)Ljava/util/ArrayList;
	void JNI_CALL_JAVA_Get_KShortestPathsWith_HopMaximumLimit(const string source, const string destination, const int maximumHop);
	...
	void JNI_CALL_JAVA_Get_KShortestPathsWith_HopRangeLimit(const string source, const string destination, const int minimumHop, const int maximumHop);
